      ...
      {sections.map((section, index) => (
        <div className="w-full flex flex-col gap-4" key={index}>
          ...
          <div className="w-full h-full gap-4 flex flex-wrap flex-row items-center justify-evenly m-auto">
            {[1, 2, 3].map((num) => (
              <div key={num} className="max-w-[30%] min-w-90 w-150 bg-white h-62 rounded-xl flex items-center justify-center border border-black shadow-[5px_5px_15px_rgba(0,0,0,0.2)]
